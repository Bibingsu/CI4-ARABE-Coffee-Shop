...
<head>
  ...
  <title>Sign Up | Café Aroma</title>
    ...
    <div class="bg-white shadow-lg rounded-2xl p-8 w-full max-w-md">
      ...
      <form action="signUp.php" method="POST" class="space-y-4">
        <div>
          ...
          <input type="text" name="name" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-yellow-600">
        </div>
        <div>
        ...
        <button type="submit" class="w-full bg-yellow-600 text-white py-2 rounded-lg hover:bg-yellow-500">Sign Up</button>
      </form>
      <p class="text-center text-sm mt-4">
        Already have an account? <a href="signIn.php" class="text-yellow-600 font-semibold">Sign In</a>
      </p>
    </div>
  </main>
</body>
